package com.wangjingxi.outsourcing.gvsinglecolor.ui;
...
public class WheelView extends View {
    private MyLog myLog = new MyLog("[WheelView] ");
    ...
    public WheelSelectedListener wheelSelectedListener;

    public static interface WheelSelectedListener {
    ...
    private void init() {
        ...
        paint.setTextSize(Tools.dip2px(getContext(), textSize));
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (wheelSelectedListener != null)
                    wheelSelectedListener.onWheelSelected();
                break;
        }
        return true;
    }
